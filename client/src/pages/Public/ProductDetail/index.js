        ...
        <div className={cl("row")}>
          ...
          <div className={cl("col-xl-6 col-lg-6")}>
            <div className={cl("product__modal-content-2")}>
              ...
              <div className={cl("product__modal-des", "mb-3")}><p>{data.description}</p></div>
              ...
              <div className={cl("product__share", "mt-3")}>
                <span>Stock :</span>
                <ul>
                  <li><Link to={"#"}>{data.ProductItems[0].stock}</Link></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className={cl("col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6")}>
            ...
            <div className={cl("product__desc-info", "mb-3")}>
              <ul>
                ...
                <li>
                  <h6>Color</h6>
                  <span>{data.ProductItems?.map((item) => item.color + " ")}</span>
                </li>
                <li>
                  <h6>Size</h6>
                  <span>{data.ProductItems?.map((item) => item.size + " ")}</span>
                </li>
                <li>
                  <h6>Total stock</h6>
                  <span>{data.ProductItems?.reduce((a, c) => a + c.stock, 0)}</span>
                </li>
              </ul>
            </div>
          </div>
