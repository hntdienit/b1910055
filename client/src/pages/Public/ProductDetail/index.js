...
import {productdetail} from '../../../services/cart'
...
function ProductDetail() {
  ...
  // const addProductToCart = async (productItemId, productQuantity) => {
  //   // console.log("id", productItemId)
  //   // console.log("sl", productQuantity)
  //   await axios
  //     .post(
  //       `${process.env.REACT_APP_URL_API}/carts/addproductitemtocart`,
  //       {
  ...
  // } else {
    ...
    const { data, error, isError, isLoading } = useQuery(['productdetail'], productdetail())
              ...
              <div className={cl("row", "product_main")}>
                <div className={cl("col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 col-xxl-3")}>
                  <div className={cl("d-block")}>
                    <Slider ref={customeSlider} {...settings}>
                      {/* {data.ProductItems[0].Images.map((item) => {
                        return (
                ...
                <div className={cl("col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xxl-8")}>
                  <div className={cl("product__modal-img", "product__thumb")}>
                    {/* <img src={data.ProductItems[0].Images[0].url} alt="" /> */}
            ...
            <div className={cl("col-xl-6 col-lg-6")}>
              <div className={cl("product__modal-content-2")}>
                ...
                <div className={cl("product__price", "mb-3")}>
                  {/* <span>${data.ProductItems[0].price}</span> */}
                ...
                <div className={cl("pro-quan-area", "d-sm-flex align-items-center")}>
                  ...
                  <div className={cl("product-quantity", "me-2 mb-2")}>
                    <div className={cl("cart-plus-minus")}>
                      <input
                        ...
                        //     setQuantity(1);
                        //   } else {
                        //     if (event.target.value > product.ProductItems[0].stock) {
                        //       setQuantity(1);
                        //       toast.error("Quantity must not be greater than stock quantity", {});
                        //     }
                        //     else {
                      ...
                      <div
                        ...
                        onClick={() => {
                          // decQuantity(data.ProductItems[0].stock);
                        }}
                      >
                        -
                      </div>
                      <div
                        ...
                        onClick={() => {
                          // incQuantity(data.ProductItems[0].stock);
                        }}
                      >
                        +
                      </div>
                  ...
                  <div className={cl("pro-cart-btn")}>
                    <button
                      type="button"
                      onClick={() => {
                        // addProductToCart(data.ProductItems[0].id, quantity);
                      }}
                ...
                <div className={cl("product__share", "mt-3")}>
                  ...
                  <ul>
                    <li>
                      {/* <Link to={"#"}>{data.ProductItems[0].stock}</Link> */}
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className={cl("col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6")}>
              ...
              <div className={cl("product__desc-info", "mb-3")}>
                <ul>
                  ...
                  <li>
                    <h6>Color</h6>
                    {/* <span>{product.ProductItems.map((item) => item.color + " ")}</span> */}
                  </li>
                  <li>
                    <h6>Size</h6>
                    {/* <span>{product.ProductItems.map((item) => item.size + " ")}</span> */}
                  </li>
                  <li>
                    <h6>Total stock</h6>
                    {/* <span>{product.ProductItems.reduce((a, c) => a + c.stock, 0)}</span> */}
                  </li>
                </ul>
              </div>
            </div>
